...
if(NOT Git_FOUND)
	message(FATAL_ERROR "Could not find 'git' tool for RP2040-LWIP-C patching")
endif()

message("RP2040-LWIP-C patch utils found")

set(RP2040_LWIP_C_SRC_DIR "${CMAKE_CURRENT_SOURCE_DIR}")
set(IOLIBRARY_DRIVER_SRC_DIR "${RP2040_LWIP_C_SRC_DIR}/libraries/ioLibrary_Driver")
set(IO6LIBRARY_DRIVER_SRC_DIR "${RP2040_LWIP_C_SRC_DIR}/libraries/io6Library")
set(PICO_SDK_SRC_DIR "${RP2040_LWIP_C_SRC_DIR}/libraries/pico-sdk")
set(PICO_SDK_LWIP_SRC_DIR "${PICO_SDK_SRC_DIR}/lib/lwip")
set(PICO_SDK_TINYUSB_SRC_DIR "${PICO_SDK_SRC_DIR}/lib/tinyusb")
set(RP2040_HAT_C_PATCH_DIR "${RP2040_LWIP_C_SRC_DIR}/patches")
...
# Delete untracked files in io6Library_Driver
if(EXISTS "${IO6LIBRARY_DRIVER_SRC_DIR}/.git")
	message("cleaning io6Library_Driver...")
	execute_process(COMMAND ${GIT_EXECUTABLE} -C ${IO6LIBRARY_DRIVER_SRC_DIR} clean -fdx)
	execute_process(COMMAND ${GIT_EXECUTABLE} -C ${IO6LIBRARY_DRIVER_SRC_DIR} reset --hard)
...
execute_process(COMMAND ${GIT_EXECUTABLE} -C ${RP2040_LWIP_C_SRC_DIR} submodule update --init)
