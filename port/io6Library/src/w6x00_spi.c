...
void wizchip_initialize(void)
{
    ...
    // PHY Configuration
    printf("Set PHY Configuration\r\n");

    uint8_t syslock = SYS_PHY_LOCK;
    ...
    printf("Get PHY Configuration\r\n");
    ctlwizchip(CW_GET_PHYCONF, (void *)&phy_conf);
    printf("mode = %x\r\n", phy_conf.mode);
    if(phy_conf.mode == PHY_MODE_MANUAL)
    {
        printf("PHY_MODE_MANUAL\r\n");
    }
    else if(phy_conf.mode == PHY_MODE_AUTONEGO)
    {
        printf("PHY_MODE_AUTONEGO\r\n");
    }
    else if(phy_conf.mode == PHY_MODE_TE)
    {
        printf("PHY_MODE_TE\r\n");
    }
    printf("speed = %x\r\n", phy_conf.speed);
    ...
    else if(phy_conf.speed == PHY_SPEED_100)
    {
        printf("PHY_SPEED_100\r\n");
    }
    printf("duplex = %x\r\n", phy_conf.duplex);
    if(phy_conf.duplex == PHY_DUPLEX_FULL)
    {
        printf("PHY_DUPLEX_FULL\r\n");
    }
    else if(phy_conf.duplex == PHY_DUPLEX_HALF)
    {
        printf("PHY_DUPLEX_HALF\r\n");
    }
}
